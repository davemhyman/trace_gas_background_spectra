...
# Sampling Inputs:
# ------------------------------------------------------------------------------
path_to_cov_file = '/data/dhyman/CrIS_bg_cov/CrIS.bg.mw_cov.summ.lon=-120.lat=+45.nc'
#
path_to_marginals_file = '/data/dhyman/CrIS_bg_cov/CrIS.bg.mw_cov.summ.lon=-120.lat=+45.nc'
#
path_to_output_file = '/data/dhyman/CrIS_bg_cov/CrIS.bg.mw_cov.summ.lon=-120.lat=+45.nc'
#
tol_dist = 1e-5
#
tol_corr = 5e-5
